  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
        <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
            <img src={show.movie.poster_path} alt="" className='max-md:mx-auto rounded-lg h-104 max-w-70 object-cover' />
            <div className='relative flex flex-col gap-3'>
                <BlurCircle top='-100px' right='-100px' />
                <p className='text-primary'>English</p>
                <h1 className='text-4xl font-semibold max-w-96 font-balance'>{show.movie.title}</h1>
                ...
                <div className='flex items-center flex-wrap gap-4 mt-4'>
                    ...
                    <button className='bg-gray-700 p-2.5 rounded-full transition cursor-pointerr active:scale-95'>
